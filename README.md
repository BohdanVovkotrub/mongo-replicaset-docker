...
> ⚠️ **Note:** Please, create new your `mongo-replication.key` and replace the original file with it. How to do it, see: https://www.mongodb.com/docs/manual/tutorial/deploy-replica-set-with-keyfile-access-control/
